...
func MakeHPTGPUBuilder() HPTGPUBuilder {
	// TODO: should this be using new? is the object being allocated on the stack?
	cbp := CommonBuilder{}
	b := HPTGPUBuilder{CommonBuilder: &cbp}
	b.SetDefaultCommonBuilderParams()
	return b
}

func (b HPTGPUBuilder) Build(name string, id uint64) *mgpusim.GPU {
	b.createGPU(name, id)
...
func (b *HPTGPUBuilder) connectCP() {
...
func (b *HPTGPUBuilder) connectL1TLBToL2TLB(chiplet *Chiplet) {
...
func (b *HPTGPUBuilder) setupInterchipNetwork() {
...
func (b *HPTGPUBuilder) InterChipletPorts(c *Chiplet) []akita.Port {
	ports := []akita.Port{
