...
func (b *Benchmark) initMem() {
	...
	if b.useUnifiedMemory {
		...
		b.gFilterData = make([]driver.GPUPtr, len(b.gpus))
		b.gHistoryData = b.driver.AllocateMemoryLASP(
			b.context, uint64(b.numTaps*4), "div4")
		b.gInputData = b.driver.AllocateMemoryLASP(
			b.context, uint64(b.Length*4), "div4")
		b.gOutputData = b.driver.AllocateMemoryLASP(
			b.context, uint64(b.Length*4), "div4")
		fmt.Printf("Footprint: %.3f MB\n",
			float64(uint64(b.numTaps*4)+uint64(b.Length*4)*2)/1024.0/1024.0)
	} else {
		b.gFilterData = make([]driver.GPUPtr, len(b.gpus))
