...
func (o *GPUOperator) SetLASPPartitionString(LASPMemPart string) {
	o.LASPMemPart = LASPMemPart
}
...
func (o *GPUOperator) Create(size []int) tensor.Tensor {
	...
	if o.LASPMemPart == "" {
		...
		t.ptr = o.driver.AllocateMemoryLASP(o.ctx, uint64(t.NumElement()*sizeOfFloat32), "div4")
	}
	fmt.Printf("Footprint: %.3f MB\n",
		float64(uint64(t.NumElement()*sizeOfFloat32))/1024.0/1024.0)
...
func (o *GPUOperator) Repeat(t tensor.Tensor, times int) tensor.Tensor {
	...
	log.Printf("Launching kernel: Repeat")
...
func (o *GPUOperator) Transpose(t tensor.Tensor, order []int) tensor.Tensor {
	...
	log.Printf("Launching kernel: Transpose")
...
func (o *GPUOperator) Rotate180(t tensor.Tensor) tensor.Tensor {
	...
	log.Printf("Launching kernel: Rotate180")
	o.driver.LaunchKernel(o.ctx,
		o.rotateKernel,
		[3]uint32{uint32(t.NumElement()), 1, 1},
		[3]uint16{64, 1, 1},
...
func (o *GPUOperator) Dilate(t tensor.Tensor, dilate []int) tensor.Tensor {
	...
	log.Printf("Launching kernel: Dilate")
	o.driver.LaunchKernel(o.ctx,
		o.dilateKernel,
...
func (o *GPUOperator) sumOneAxis(t tensor.Tensor, axis int) tensor.Tensor {
	...
	log.Printf("Launching kernel: sumOneAxis")
...
func (o *GPUOperator) matrixMultiplication(
	...
	log.Printf("Launching kernel: matrixMultiplication")
...
func (o *GPUOperator) Im2Col(
	...
	log.Printf("Launching kernel: Im2Col")
	o.driver.LaunchKernel(
		o.ctx,
		o.im2ColKernel,
...
func (o *GPUOperator) MaxPoolingForward(
	...
	log.Printf("Launching kernel: MaxPoolingForward")
	o.driver.LaunchKernel(
		o.ctx,
...
func (o *GPUOperator) MaxPoolingBackward(
	...
	log.Printf("Launching kernel: MaxPoolingBackward")
	o.driver.LaunchKernel(o.ctx,
...
func (o *GPUOperator) AvgPoolingForward(
	...
	log.Printf("Launching kernel: AvgPoolingForward")
	o.driver.LaunchKernel(
		o.ctx,
...
func (o *GPUOperator) AvgPoolingBackward(
	...
	log.Printf("Launching kernel: AvgPoolingBackward")
	o.driver.LaunchKernel(
		o.ctx,
...
func (o *GPUOperator) Softmax(t tensor.Tensor) tensor.Tensor {
	...
	log.Printf("Launching kernel: SoftmaxExp")
	...
	log.Printf("Launching kernel: SoftmaxDiv")
...
func (o *GPUOperator) CrossEntropyDerivative(
	...
	log.Printf("Launching kernel: CrossEntropyDerivative")
...
func (o *GPUOperator) SoftmaxCrossEntropyDerivative(
	...
	log.Printf("Launching kernel: SoftmaxCrossEntropyDerivative")
...
func (o *GPUOperator) ElementWiseMul(
	...
	log.Printf("Launching kernel: ElementWiseMul")
...
func (o *GPUOperator) ScaleAdd(
	...
	log.Printf("Launching kernel: ScaleAdd")
...
func (o *GPUOperator) RMSProp(
	...
	log.Printf("Launching kernel: RMSProp")
...
func (o *GPUOperator) Adam(
	...
	log.Printf("Launching kernel: Adam")
...
func (o *GPUOperator) ReluForward(
	...
	log.Printf("Launching kernel: ReluForward")
...
func (o *GPUOperator) ReluBackward(
	...
	log.Printf("Launching kernel: ReluBackward")
