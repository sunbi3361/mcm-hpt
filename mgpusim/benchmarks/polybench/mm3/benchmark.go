...
func (b *Benchmark) initMem() {
	...
	if b.useUnifiedMemory {
		...
		b.dc = b.driver.AllocateMemoryLASP(b.context,
			uint64(b.NJ*b.NM*4), "div4")
		b.dd = b.driver.AllocateMemoryLASP(b.context,
			uint64(b.NM*b.NL*4), "div4")
		b.de = b.driver.AllocateMemoryLASP(b.context,
			uint64(b.NI*b.NJ*4), "div4")
		b.df = b.driver.AllocateMemoryLASP(b.context,
			uint64(b.NJ*b.NL*4), "div4")
		b.dg = b.driver.AllocateMemoryLASP(b.context,
	...
	fmt.Printf("Footprint: %.3f MB\n",
		float64(uint64(b.NI*b.NK*4)+uint64(b.NK*b.NJ*4)+uint64(b.NJ*b.NM*4)+uint64(b.NM*b.NL*4)+uint64(b.NI*b.NJ*4)+uint64(b.NJ*b.NL*4)+uint64(b.NI*b.NL*4))/1024.0/1024.0)
}
