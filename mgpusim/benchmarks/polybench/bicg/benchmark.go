...
func (b *Benchmark) initMem() {
	...
	if b.useUnifiedMemory {
		...
		b.dR = b.driver.AllocateMemoryLASP(b.context,
			uint64(b.NX*4), "div4")
		b.dS = b.driver.AllocateMemoryLASP(b.context,
			uint64(b.NY*4), "div4")
		b.dP = b.driver.AllocateMemoryLASP(b.context,
			uint64(b.NY*4), "div4")
		b.dQ = b.driver.AllocateMemoryLASP(b.context,
			uint64(b.NX*4), "div4")
		fmt.Printf("Footprint: %.3f MB\n",
			float64(uint64(b.NY*b.NX*4)+uint64(b.NX*4)*2+uint64(b.NY*4)*2)/1024.0/1024.0)
	} else {
