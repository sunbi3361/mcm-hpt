...
func (b *Benchmark) initMem() {
	...
	if b.useUnifiedMemory {
		...
		b.dFrontier = b.driver.AllocateMemoryLASP(b.context,
			uint64(b.NumNode*4), "div4")
		b.dEdgeArray = b.driver.AllocateMemoryLASP(b.context,
			uint64((b.NumNode+1)*4), "div4")
		b.dEdgeArrayAux = b.driver.AllocateMemoryLASP(b.context,
			uint64(len(b.hEdgeList)*4), "div4")
		b.dFlag = b.driver.AllocateMemoryLASP(b.context, 4, "div4")
	} else {
	...
	fmt.Printf("Footprint: %.3f MB\n", float64(float64(uint64(b.NumNode*4)+uint64((b.NumNode+1)*4)+uint64(len(b.hEdgeList)*4)+4)/1024/1024))
}
