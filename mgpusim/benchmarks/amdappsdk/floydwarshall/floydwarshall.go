...
func (b *Benchmark) initMem() {
	...
	if b.useUnifiedMemory {
		...
		b.dOutputPathMatrix = b.driver.AllocateMemoryLASP(
			b.context,
			uint64(numNodes*numNodes*4), "div4")
		b.dOutputPathDistanceMatrix = b.driver.AllocateMemoryLASP(
			b.context,
			uint64(numNodes*numNodes*4), "div4")
	} else {
	...
	fmt.Printf("Footprint: %.3f MB\n",
		float64(uint64(numNodes*numNodes*4)*2)/1024.0/1024.0)
