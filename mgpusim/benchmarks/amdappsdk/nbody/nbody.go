...
func (b *Benchmark) initMem() {
	...
	if b.useUnifiedMemory {
		...
		b.currPos = b.driver.AllocateMemoryLASP(b.context,
			uint64(b.numBodies*4*4), "test")
		b.newPos = b.driver.AllocateMemoryLASP(b.context,
			uint64(b.numBodies*4*4), "test")
		b.currVel = b.driver.AllocateMemoryLASP(b.context,
			uint64(b.numBodies*4*4), "test")
		b.newVel = b.driver.AllocateUnifiedMemory(b.context,
			uint64(b.numBodies*4*4))
	} else {
	...
	fmt.Printf("Footprint: %.3f MB\n",
		float64(uint64(b.numBodies*4*4)*4)/1024.0/1024.0)
