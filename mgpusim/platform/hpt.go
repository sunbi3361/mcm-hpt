...
type HPTPlatformBuilder struct {
	CommonPlatformBuilder
}

// Makebuilder creates a EmuBuilder with default parameters.
func MakeHPTPlatformBuilder() HPTPlatformBuilder {
	b := HPTPlatformBuilder{
		CommonPlatformBuilder{
			numGPU:                   1,
...
func (b HPTPlatformBuilder) Build() (akita.Engine, *driver.Driver) {
...
func (b *HPTPlatformBuilder) createGPUBuilder(
	engine akita.Engine,
